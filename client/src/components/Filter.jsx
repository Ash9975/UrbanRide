    ...
    const handleData = async (formData) => {
        ...
        try {
            const res = await fetch(
                `${import.meta.env.VITE_API_URL}/user/filterVehicles`,
                {
                    method: "POST",
            ...
            let filtData = data.data.filteredVehicles;

            if (allVariants) {
                filtData = filtData.filter((v) =>
                    allVariants.some((a) => a._id === v._id)
                );
            }
                                ...
                                <form className="w-full" onSubmit={handleSubmit(handleData)}>
                                    ...
                                    <div className="mt-7 pt-7 border-t border-t-gray-300">
                                        <button
                                            ...
                                            onClick={() => window.innerWidth <= 924 && setFilterOpen(false)}
                                        >
                                            Apply
                                        </button>
                                    </div>
