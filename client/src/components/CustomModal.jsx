...
const Modal = ({
    ...
    const checkOutsideAndCloseModal = (e) => {
        ...
        if (!modalRef.current || !mouseDownEv) return;
    ...
    return (
        <>
            <Portal>
                <div
                    className={`fixed top-0 left-0 bottom-0 right-0 flex items-center justify-center overflow-hidden bg-black bg-opacity-80 backdrop-blur-md duration-500 ${isOpen
